...
if [ ! -f /usr/share/nginx/www/wp-config.php ]; then
  ...
  # This replaces placeholder text from the config-sample.php with the Wordpress MySQL user password & "wordpress" as the user
  # various security strings are replaced by dynamically generated passwords
  #
  # TODO: No changes needed here, I don't think
  #
